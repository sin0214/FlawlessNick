...
public class CapeManager {
    ...
    public void addCape() {
        this.usingCape = true;
        Minecraft.getMinecraft().addScheduledTask(() -> setCape(new ResourceLocation(FlawlessNick.MODID, "cape.png")));
    }
    ...
    protected ResourceLocation getOfCape(String name) {
        if (name != null && !name.isEmpty()) {
            ...
            File file1 = new File(new File("./mods/FlawlessNick".replace("/", File.separator), "ofcape"), id);
